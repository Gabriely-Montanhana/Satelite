...
$tituloPagina = 'Tornearia Satélite | Home';
$paginaAtual = 'home';
$erro = null;
...
<?php if ($erro != null): ?>
    <div class="alert alert-danger" role="alert">
        Não foi possível carregar os produtos em destaque: <?= htmlspecialchars($erro) ?>
    </div>
<?php else: ?>
    <section>
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="produtos.php" class="btn btn-outline-satelite d-none d-md-inline-block">Ver catálogo completo</a>
        </div>
        ...
        <div class="text-center d-md-none">
            <a href="produtos.php" class="btn btn-outline-satelite">Ver catálogo completo</a>
        </div>
    </section>
<?php endif; ?>
